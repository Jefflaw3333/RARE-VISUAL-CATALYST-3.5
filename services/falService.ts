...
// NOTE: This service reads the FAL API key from user-configured localStorage.
...
export const generateVideo = async (
    ...
    if (!falKey) {
        throw new Error("FAL API Key is not configured. Please add it in the API Key Manager.");
    }
